...
function is_tracking($tnumber)
{
    global $cnx;

    $sql = "SELECT * FROM tracking WHERE tnumber = '$tnumber'";

    $req = $req = $cnx->query($sql);
...
if (isset($_POST['submit']) && isset($_POST['tnumber'])) {

    $tnumber = $_POST['tnumber'];

    $confirm = is_tracking($tnumber);
    ...
    echo "<script>window.location.href = 'track-your-shipment.html' </script>";
}
...
<head>
    ...
    <meta name="description" content="Logistic Cargo Express Limited - We Deal With your Logistics & Shipping Needs!">
    ...
    <title>Tracking Details - Logistic Cargo Express Limited</title>

    <!-- .\wget.exe -r https://https://equitacargo.com/css -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 d-flex justify-content-center justify-content-lg-start">
                        <a href="track-your-shipment.html">Track Your Shipment Anytime Anywhere</a>
                    </div>
                    <div class="col-lg-6 d-sm-flex justify-content-center justify-content-lg-end">
                        <ul class="list-unstyled d-flex justify-content-center mb-0 mr-sm-5">
                            ...
                            <li><a href="#">(+237) 677 275 992</a></li>
                        </ul>
...
-->
            ...
            <div class="row">
                ...
                <?php foreach ($getTrackings as $getTracking) : ?>
                    ...
                    <div class="col-md-6 text-center">
                        <h4><b>Tracking No : <?= $getTracking['tnumber'] ?></b> </h4>
                    </div>
                    <hr>
                    <br>
                    <br>
                    <div class="col-md-12 col-md-offset-0">
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        <tbody>
                                            <tr>
                                                <td><b>Name:</b> </td>
                                                <td> <?= $getTracking['sname'] ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>Contact:</b> </td>
                                                <td> <?= $getTracking['scontact'] ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>Email:</b> </td>
                                                <td> <?= $getTracking['smail'] ?> </td>
                                            </tr>
                                            <tr>
                                                <td><b>Address:</b> </td>
                                                <td> <?= $getTracking['sadresse'] ?> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <table class="table table-hover" id="dev-table">
                                        <tbody>
                                            <tr>
                                                <td><b>Name:</b> </td>
                                                <td> <?= $getTracking['rname'] ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>Contact:</b> </td>
                                                <td> <?= $getTracking['rcontact'] ?> </td>
                                            </tr>
                                            <tr>
                                                <td><b>Email:</b> </td>
                                                <td><?= $getTracking['rmail'] ?></td>
                                            </tr>
                                            <tr>
                                                <td><b>Address:</b></td>
                                                <td> <?= $getTracking['radresse'] ?> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <table class="table table-striped table-bordered table-condensed">
                            <tbody>
                                <tr>
                                    <td class="text-center"><b>Carier </b></td>
                                    <td><img src="images/brands/<?= $getTracking['carier'] ?>.png" width="100px" alt="" srcset=""></td>
                                </tr>
                                <tr>
                                    <td class="text-center"><b>Parcel Description </b></td>
                                    <td><?= $getTracking['description'] ?></td>
                                </tr>
                                <tr>
                                    <td class="text-center"><b>Dispatch Location </b></td>
                                    <td> <?= $getTracking['dispatchl'] ?> </td>
                                </tr>
                    ...
                    <table class="table table-striped table-bordered table-condensed">
                        <tbody>
                            <?php
                            $adress = $getTracking['current_loc'];
                            ...
                            <iframe class="map" src="https://maps.google.com/maps?q=<?= $adress ?>&output=embed" style="border:0; width: 100%; height: 500px;"></iframe>
                        </tbody>
                    </table>
                ...
                <!-- <center><a href="../receipt.php?tnumber=U6XJH4DOV3" class="btn btn-primary">Print Receipt</a></center>
                ...
                <br><br>
                <div class="ml-3">
                    <form action="track.php" method="post" style="margin-bottom:50px">
    ...
    <!-- footer-->
    <div class="mt-5"></div>
    <footer class="footer space-pt bg-dark mt-n5 log-mt-md-n4 log-mt-lg-n5 log-mt-xl-n7 mt-5">
                ...
                <div class="col-sm-6 col-lg-3 order-lg-1 mb-5 mb-lg-0">
                    ...
                    <ul class="footer-contact list-unstyled">
                        ...
                        <li>
                            ...
                            <div class="footer-contact-info">
                                <a href="https://wa.me/447883241596">
                                    <img style="src: url(images/whatsap.png)"> <span>(+237) 677 275 992
                                    </span>
                                </a>
                        ...
                        <li>
                            ...
                            <div class="footer-contact-info">
                                <span>logisticcargoexpress@gmail.com</span>
            ...
            <div class="copyright">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6 text-left text-md-right mt-4 mt-md-0">
                        <p class="mb-0 text-white">©️ 2024 Logistic Cargo Express. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
